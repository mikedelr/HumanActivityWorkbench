...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;a_{\text{lpfdif},x}[k]=\sum_{i=0}^{N}b[i]\bullet{}a[k-i]" title="\Large a_{\text{lpfdif},x}[k]=\sum_{i=0}^{N}b[i]\bullet{}a[k-i]" />
